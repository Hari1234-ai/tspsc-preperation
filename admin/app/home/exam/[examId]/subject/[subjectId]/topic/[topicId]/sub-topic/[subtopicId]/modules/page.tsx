...
export default function ContentEditor() {
  const { examId, subjectId, topicId, subtopicId } = useParams();
    ...
    <div className="font-sans max-w-7xl mx-auto text-white pb-32">
        ...
        <div className="flex items-center gap-8">
           ...
           <div>
              ...
              <p className="text-gray-500 font-bold mt-1 uppercase text-[10px] tracking-[0.3em]">
                 Sub-topic Architect / <span className="text-[#6366f1]">{subtopicId}</span>
              </p>
           </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-10">
          <div className="bg-[#0d1117] border border-gray-800 rounded-[3rem] p-12 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-10">
               ...
               <div className="flex items-center gap-2 p-3 bg-green-500/5 border border-green-500/10 rounded-xl">
                  ...
                  <span className="text-[10px] font-black text-green-500 uppercase tracking-widest leading-none">Cloud Sync Active</span>
               </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="bg-[#161b22] border border-gray-800 rounded-[2rem] overflow-hidden focus-within:border-[#6366f1] focus-within:ring-4 focus-within:ring-indigo-500/5 transition-all shadow-inner">
                ...
                <textarea 
                  ...
                  placeholder="Begin sculpting the educational narrative..."
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 pt-6">
                ...
                <div className="space-y-4">
                  <label className="block text-[10px] font-black text-gray-600 uppercase tracking-[0.3em] ml-2">Indexing Status</label>
                  <div className="p-6 bg-[#6366f1]/5 border border-indigo-500/10 rounded-2xl flex items-center justify-between">
                     <span className="text-xs font-black text-[#6366f1] uppercase tracking-[0.1em]">Verified for Production</span>
          ...
          <div className="bg-[#0d1117] border border-gray-800 rounded-[2.5rem] p-12 shadow-sm border-dashed group hover:border-[#6366f1]/30 transition-all duration-500">
             <div className="flex justify-between items-center">
                <div className="flex items-center gap-6">
                   <div className="w-16 h-16 bg-[#161b22] rounded-2xl flex items-center justify-center text-gray-600 group-hover:bg-[#6366f1] group-hover:text-white transition-all duration-500">
                      <Video size={28} />
                   </div>
                   <div>
                      <h3 className="text-xl font-black text-white italic">Multimedia Reels</h3>
                      <p className="text-sm text-gray-500 font-bold">Manage hyper-focused lecture clips and podcasts</p>
                   </div>
                </div>
                <button className="bg-[#161b22] border border-gray-800 text-white px-8 py-4 rounded-xl font-black text-xs hover:bg-[#6366f1] hover:border-transparent transition-all shadow-lg active:scale-95">
                  + Add Media Asset
                </button>
             </div>
          </div>
        ...
        <div className="lg:col-span-4 space-y-12">
           <div className="bg-black rounded-[3rem] p-10 border border-gray-900 shadow-3xl">
              <div className="flex items-center gap-3 mb-10">
                 ...
                 <h2 className="text-white text-[10px] font-black uppercase tracking-[0.3em]">Live Core Preview</h2>
              </div>
              ...
              <div className="aspect-[9/18] bg-[#0d1117] rounded-[2.5rem] overflow-hidden relative border border-gray-800 flex flex-col group/preview">
                <div className="h-2/5 bg-[#161b22] flex items-center justify-center relative group-hover/preview:scale-105 transition-transform duration-700">
                   ...
                   <div className="absolute top-6 left-6 px-3 py-1.5 bg-black/40 backdrop-blur-md rounded-lg border border-white/5">
                      <span className="text-[8px] font-black text-white/50 uppercase tracking-widest">4K Asset</span>
                   </div>
                </div>
                <div className="flex-1 bg-gradient-to-b from-[#161b22] to-[#0d1117] p-10 flex flex-col justify-end border-t border-gray-800 shadow-inner">
                  ...
                  <p className="text-gray-500 text-sm font-bold leading-relaxed line-clamp-4 italic">
                    {description || 'System waiting for educational payload. Begin typing in the editor to sync preview manifest...'}
                  </p>
                </div>
              </div>
           </div>

           <div className="p-10 bg-red-500/5 border border-red-500/10 rounded-[3rem] group hover:bg-red-500/10 transition-all duration-500">
              <h3 className="text-red-500 font-black text-xs mb-3 uppercase tracking-[0.2em] flex items-center gap-2">
                 <Trash2 size={16} />
                 Terminal Protocol
              </h3>
              <p className="text-gray-500 text-xs font-bold mb-8 leading-relaxed italic">"Warning: Immediate erasure of this sub-topic node and all its nested curriculum modules. This action is recursive."</p>
              <button className="w-full py-5 bg-[#161b22] border border-red-500/20 text-red-500 rounded-2xl font-black text-xs hover:bg-red-500 hover:text-white transition-all shadow-xl active:scale-95 uppercase tracking-widest">
                Purge Research Node
              </button>
           </div>
        </div>
